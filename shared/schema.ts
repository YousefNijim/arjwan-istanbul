...
export const perfumes = pgTable('perfumes', {
  ...
  usageTr: text('usage_tr').notNull().default('Temiz tene veya kıyafete istenilen sıklıkta uygulanır. Kalıcılığı artırmak için nabız noktalarına (bilek içleri, boyun) sıkılması önerilir.'),
