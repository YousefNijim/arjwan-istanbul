...
const CouplesEidBundle = () => {
  ...
  const handleAddToCart = () => {
    addItem({
      ...
      name: 'Eid Couples Collection — Aseel + Hürra (100ml each)',
      size: '100ml',
      concentration: 'heavy',
      quantity: 1,
      price: BUNDLE_PRICE,
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[55vh] min-h-[360px] overflow-hidden">
        {HERO_IMAGE
          ? <img src={HERO_IMAGE} alt="Eid Couples Collection" className="w-full h-full object-cover" />
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          >
            <span className="inline-flex items-center gap-2 bg-red-500/10 border border-red-500/30 text-red-400 text-[11px] tracking-[0.3em] uppercase px-4 py-1.5 rounded-full mb-6">
              Limited Stock · Eid Offer
            </span>
            <h2 className="font-display text-3xl md:text-4xl text-primary tracking-wider mb-2">
              Eid Couples Collection
            </h2>
            <p className="text-muted-foreground text-lg mb-6">
              The Perfect Eid Gift — For Him &amp; For Her
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
            ...
            <motion.div
              ...
              className="bg-card border border-[hsl(270_52%_34%/0.45)] rounded-sm overflow-hidden"
            >
              <div className="aspect-[3/4] relative overflow-hidden">
                {ASEEL_IMAGE
                  ? <img src={ASEEL_IMAGE} alt="Aseel" className="w-full h-full object-cover" />
                  : <Placeholder />
                }
                <span className="absolute top-3 start-3 bg-[hsl(270_52%_34%)] text-white text-[10px] tracking-[0.3em] uppercase px-3 py-1">
                  For Him
                </span>
              </div>
              <div className="p-6">
                <h3 className="font-display text-xl text-primary tracking-wider mb-1">Aseel | أصيل</h3>
                <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                  Warm, woody, and boldly masculine. A signature scent that commands presence.
                </p>
            ...
            <motion.div
              ...
              className="bg-card border border-[hsl(43_76%_52%/0.35)] rounded-sm overflow-hidden"
            >
              <div className="aspect-[3/4] relative overflow-hidden">
                {HURRA_IMAGE
                  ? <img src={HURRA_IMAGE} alt="Hürra" className="w-full h-full object-cover" />
                  : <Placeholder />
                }
                <span className="absolute top-3 start-3 bg-[hsl(43_76%_52%)] text-black text-[10px] tracking-[0.3em] uppercase px-3 py-1">
                  For Her
                </span>
              </div>
              <div className="p-6">
                <h3 className="font-display text-xl text-primary tracking-wider mb-1">Hürra | حرة</h3>
                <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                  Bold, floral, and beautifully free. A scent that celebrates the modern woman.
                </p>
                <span className="text-xs text-muted-foreground/60 tracking-widest uppercase border border-border px-2.5 py-1">
                  100ml
                </span>
